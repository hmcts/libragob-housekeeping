...
echo "Script Version 6.3: Check #6"
...
total_dacRT=1101
total_gwRT=799
total_roundtrip=`printf %.3f "$((10**3 * $db_dacRT+$total_dacRT+$total_gwRT))e-3"`
total_roundtrip_secs=`printf %.3f "$((10**3 * $total_roundtrip/1000))e-3"`
delivery_rate_secs=`printf %.3f "$((10**3 * $sum_number_of_table_updates/$total_roundtrip_secs))e-3"`
