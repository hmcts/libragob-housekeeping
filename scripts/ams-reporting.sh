...
#ssh-keygen -v 3 -t rsa -b 4096 -f /tmp/ams-reporting/ams-reporting
#sudo -u $sftp-username ssh-keygen -t rsa -b 4096 -f /tmp/ams-reporting/ams-reporting
...
ssh -v -i /mnt/secrets/$KV_NAME/sftp-pvt-key ${sftp_username}@${sftp_endpoint} << EOF
