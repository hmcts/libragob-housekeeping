...
echo "Script Version 17.8 met 44 tierage tuneup"
...
elif [[ $schema_id == 61 ]] || [[ $schema_id == 139 ]] || [[ $schema_id == 57 ]] || [[ $schema_id == 47 ]] || [[ $schema_id == 8 ]] || [[ $schema_id == 82 ]] || [[ $schema_id == 138 ]] || [[ $schema_id == 124 ]];then
