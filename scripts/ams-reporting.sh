...
echo "Script Version 17.9 met 31 82 105 tierage tuneup"
...
if [[ $schema_id == 77 ]] || [[ $schema_id == 44 ]] || [[ $schema_id == 31 ]] || [[ $schema_id == 82 ]] || [[ $schema_id == 105 ]];then
  t_delta_threshold_mins=$((90*5))
elif [[ $schema_id == 135 ]] || [[ $schema_id == 112 ]] || [[ $schema_id == 61 ]] || [[ $schema_id == 130 ]] || [[ $schema_id == 124 ]] || [[ $schema_id == 47 ]] || [[ $schema_id == 99 ]];then
