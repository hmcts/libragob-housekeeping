...
echo "Script Version 19.4 129 Tier4"
...
elif [[ $schema_id == 44 ]] || [[ $schema_id == 31 ]] || [[ $schema_id == 82 ]] || [[ $schema_id == 105 ]] || [[ $schema_id == 135 ]] || [[ $schema_id == 89 ]] || [[ $schema_id == 38 ]] || [[ $schema_id == 129 ]];then
