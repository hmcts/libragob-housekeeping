...
echo "Script Version 19.4 Check #6 38 Tier6"
...
if [[ $schema_id == 77 ]] || [[ $schema_id == 38 ]];then
  t_delta_threshold_mins=$((90*6))
elif [[ $schema_id == 44 ]] || [[ $schema_id == 31 ]] || [[ $schema_id == 82 ]] || [[ $schema_id == 105 ]] || [[ $schema_id == 135 ]] || [[ $schema_id == 89 ]] || [[ $schema_id == 129 ]];then
