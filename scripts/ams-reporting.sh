...
echo "Script Version 5.9: Check #6"
...
total_roundtrip_secs=`echo "scale=2;$total_roundtrip/1000" | bc`
delivery_rate_secs=`echo "scale=2;$sum_number_of_table_updates/$total_roundtrip_secs" | bc`
